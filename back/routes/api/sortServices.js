...
router.get('/',jsonParser, async (req, res) => {
        try{
            // 1. Сортировка по Марке авто
            // 2. Сортировка по ФИО клиента
            // 3. Сортировка по ФИО Сотрудника
            // 4. Сортировка по дате начала ремонта
            // 5. Сортировка по дате окончания ремонта
